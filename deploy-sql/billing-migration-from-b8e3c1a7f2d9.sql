...
INSERT INTO contract_plan (code, name, min_seats, max_seats, unit_price_cents, total_cents, currency, term_months, active, sort_order, created_at, updated_at) VALUES ('starter', 'Starter (up to 100 readers)', 1, 100, 1900, 190000, 'EUR', 12, true, 1, '2026-07-27 15:41:36.389715', '2026-07-27 15:41:36.389715');

INSERT INTO contract_plan (code, name, min_seats, max_seats, unit_price_cents, total_cents, currency, term_months, active, sort_order, created_at, updated_at) VALUES ('growth', 'Growth (101-500 readers)', 101, 500, 1300, 650000, 'EUR', 12, true, 2, '2026-07-27 15:41:36.389715', '2026-07-27 15:41:36.389715');

INSERT INTO contract_plan (code, name, min_seats, max_seats, unit_price_cents, total_cents, currency, term_months, active, sort_order, created_at, updated_at) VALUES ('scale', 'Scale (501-1000 readers)', 501, 1000, 800, 800000, 'EUR', 12, true, 3, '2026-07-27 15:41:36.389715', '2026-07-27 15:41:36.389715');
